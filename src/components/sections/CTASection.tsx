...
export default function CTASection() {
  return (
    <section className="w-full bg-gradient-to-r from-emerald-900/50 via-slate-800/80 to-amber-900/50 backdrop-blur-sm py-20 mt-12 rounded-3xl shadow-2xl border border-amber-400/20 mx-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 px-9">
        <div className="flex-1">
          <h2 className="text-4xl md:text-5xl font-black text-slate-100 mb-6">
            ...
            <span className="text-amber-400"> nationwide expertise</span>?
          </h2>
          ...
          <div className="flex items-center gap-6 mt-6 text-amber-400 font-semibold">
        ...
        <div className="flex gap-6 flex-col sm:flex-row">
          <Link 
            to="/contact" 
            className="bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-slate-900 font-black px-10 py-5 text-xl rounded-2xl shadow-2xl transition-all duration-300 hover-scale text-center"
          >
            Start Your Journey
          </Link>
          <Link 
